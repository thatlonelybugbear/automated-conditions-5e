...
function showUsageRuleKeys() {
	return {
		...
		mode: 'String: AC5E rule mode such as "advantage", "disadvantage", "bonus", "info", "modifiers", "targetADC", "abilityOverride", "criticalThreshold", "fumbleThreshold", "extraDice", "modifyDenomination", "range", "fail", "success", or "critical".',
