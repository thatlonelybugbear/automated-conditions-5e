import { _preRollConcentration, _preRollAbilitySave, _preRollSkill, _preRollAbilityTest, _preRollAttack, _preRollDamage, _preRollAttackV2, _preRollDamageV2, _preRollDeathSave, _preUseItem, _preUseActivity, _renderHijack } from './ac5e-hooks.mjs';
...
function ac5eSetup() {
	...
	const preRollConcentration = v4_1 ? Hooks.on('dnd5e.preRollConcentrationV2', _preRollConcentration) : _systemCheck('3.0.4') ? Hooks.on('dnd5e.preRollConcentration', _preRollConcentration) : 'This will only be added for users with dnd5e 3.1+';
