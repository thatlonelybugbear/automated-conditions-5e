...
export async function migrate() {
    const { flags: { lastMigrationPoint }, version } = game.modules.get(Constants.MODULE_ID);
    if (settings.debug) console.warn(`${Constants.MODULE_ID} lastMigrationPoint: ${lastMigrationPoint}`);
